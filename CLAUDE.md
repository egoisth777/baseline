...
[`references/ubi_lang.md`](references/ubi_lang.md).

- **Consult `references/ubi_lang.md` before introducing any new word or concept.** Reuse the
...
- If a genuinely new concept appears that no existing term covers, **add it to
  ...
  is implemented).
- `references/ubi_lang.md` is the single source of truth for project vocabulary. Do not create
